            ...
            <div className="page-card">
                <div className="mb-5 space-y-3">
                    ...
                    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-[180px_190px_190px_190px_auto]">
                        ...
                        <SmartSelect value={kategoriId} onChange={(value) => setKategoriId(value)} options={[{ id: "", nama_kategori: "Semua kategori" }, ...kategoris]} placeholder="Semua kategori" getOptionValue={(x) => x.id} getOptionLabel={(x) => x.nama_kategori} />
