    ...
    return (
        <AppLayout title={isEdit ? 'Edit Program Kerja' : 'Tambah Program Kerja'}>
            ...
            <form onSubmit={submit} className="page-card grid gap-4 md:grid-cols-2">
                ...
                <SmartSelect label="Kategori" value={form.data.kategori_id} onChange={(value) => form.setData('kategori_id', value)} options={kategoris} placeholder="Pilih kategori" required getOptionValue={(x) => x.id} getOptionLabel={(x) => x.nama_kategori} />
